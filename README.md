...
* I would additionally add some security to the endpoints by implementing an authentication module that intakes some form of client id and secret then issues out  time based token that allows access to the POST endpoint.
